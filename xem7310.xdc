####################################################################################
# XEM7310 Constraints File - pdShank_v7310
# FPGA: XC7A75T-1FGG484C
# Board: Opal Kelly XEM7310-A75
# Design: pdShank photodiode array readout with DDR3 buffering
...
set_input_delay -clock sys_clk -min 0.200 [get_ports sys_clk_p]
set_input_delay -clock sys_clk -max 0.800 [get_ports sys_clk_p]
set_input_delay -clock sys_clk -min 0.200 [get_ports sys_clk_n] -clock_fall
set_input_delay -clock sys_clk -max 0.800 [get_ports sys_clk_n] -clock_fall

create_generated_clock -name ui_clk -source [get_ports sys_clk_p] -divide_by 2 [get_pins memory_controller/ui_clk]
set_clock_groups -physically_exclusive -group [get_clocks sys_clk] -group [get_clocks ui_clk]

create_generated_clock -name clk_generated_intclk -source [get_pins clk_mgmt/clk_in1] -multiply_by 2 [get_pins clk_mgmt/clk_out1]

create_clock -name okClk -period 9.920 [get_nets okClk]

# REF_OUT and clk_ramp are generated using ODDR primitives
# They are derived from clk_generated_intclk but need to be treated as output clocks
create_generated_clock -name ref_out_clk -source [get_pins refoutbuffer/C] -divide_by 1 [get_ports REF_OUT]
create_generated_clock -name clk_ramp_out -source [get_pins clkrampbuffer/C] -divide_by 1 [get_ports clk_ramp]

set_clock_groups -name sys_mem_clks -asynchronous \
    -group [get_clocks {sys_clk ui_clk}] \
    -group [get_clocks clk_generated_intclk] \
    -group [get_clocks okClk] \
    -group [get_clocks {ref_out_clk clk_ramp_out}]

set_clock_uncertainty -setup 0.200 [get_clocks sys_clk]
set_clock_uncertainty -hold 0.100 [get_clocks sys_clk]

set_clock_uncertainty -setup 0.150 [get_clocks ui_clk]
set_clock_uncertainty -hold 0.075 [get_clocks ui_clk]

set_clock_uncertainty -setup 0.150 [get_clocks clk_generated_intclk]
set_clock_uncertainty -hold 0.075 [get_clocks clk_generated_intclk]

set_clock_uncertainty -setup 0.200 [get_clocks okClk]
set_clock_uncertainty -hold 0.100 [get_clocks okClk]

# For FIFO interfaces that cross clock domains, allow multiple cycles
# This is particularly important for your FIFO_I16b_O128b and FIFO_I256b_O32b
set_multicycle_path -setup 2 -from [get_clocks clk_generated_intclk] -to [get_clocks ui_clk]
set_multicycle_path -hold 1 -from [get_clocks clk_generated_intclk] -to [get_clocks ui_clk]

set_multicycle_path -setup 2 -from [get_clocks ui_clk] -to [get_clocks okClk]
set_multicycle_path -hold 1 -from [get_clocks ui_clk] -to [get_clocks okClk]

############################################################################
## User Reset
############################################################################
set_property PACKAGE_PIN Y18 [get_ports {OKreset}]
set_property IOSTANDARD LVCMOS18 [get_ports {OKreset}]
set_property SLEW FAST [get_ports {OKreset}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
## MC1-28 
set_property PACKAGE_PIN W6 [get_ports {clk_sel}]
set_property IOSTANDARD LVCMOS33 [get_ports {clk_sel}]
## MC1-29 
set_property PACKAGE_PIN U5 [get_ports {enRow_init}]
set_property IOSTANDARD LVCMOS33 [get_ports {enRow_init}]
## MC1-30 
set_property PACKAGE_PIN W5 [get_ports {enRow_rst}]
set_property IOSTANDARD LVCMOS33 [get_ports {enRow_rst}]
## MC1-31 
set_property PACKAGE_PIN AA5 [get_ports {clk_rst}]
set_property IOSTANDARD LVCMOS33 [get_ports {clk_rst}]
## MC1-32 
set_property PACKAGE_PIN R4 [get_ports {glob_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {glob_tx}]
## MC1-33 
set_property PACKAGE_PIN AB5 [get_ports {glob_grst}]
set_property IOSTANDARD LVCMOS33 [get_ports {glob_grst}]
## MC1-34 
set_property PACKAGE_PIN T4 [get_ports {ramp_swRst}]
set_property IOSTANDARD LVCMOS33 [get_ports {ramp_swRst}]
## MC1-35 
#set_property PACKAGE_PIN  [get_ports {}]
#set_property IOSTANDARD  [get_ports {}]
## MC1-36 
...
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
## MC1-44 
set_property PACKAGE_PIN AA6 [get_ports {clk_ramp}]
set_property IOSTANDARD LVCMOS33 [get_ports {clk_ramp}]
set_property SLEW FAST [get_ports {clk_ramp}]
## MC1-45 
...
#set_property IOSTANDARD  [get_ports {}]
## MC1-57 
set_property PACKAGE_PIN Y2 [get_ports {rst_ramp}]
set_property IOSTANDARD LVCMOS33 [get_ports {rst_ramp}]
## MC1-58 
set_property PACKAGE_PIN Y1 [get_ports {en_count}]
set_property IOSTANDARD LVCMOS33 [get_ports {en_count}]
## MC1-59 
set_property PACKAGE_PIN T1 [get_ports {en_shift}]
set_property IOSTANDARD LVCMOS33 [get_ports {en_shift}]
## MC1-60 
set_property PACKAGE_PIN AB3 [get_ports {rst_shift}]
set_property IOSTANDARD LVCMOS33 [get_ports {rst_shift}]
## MC1-61 
set_property PACKAGE_PIN U1 [get_ports {clk_shift}]
set_property IOSTANDARD LVCMOS33 [get_ports {clk_shift}]
## MC1-62 
...
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
## MC1-67 
set_property PACKAGE_PIN AB16 [get_ports {DOUT[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[0]}]
## MC1-68 
set_property PACKAGE_PIN AA13 [get_ports {DOUT[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[1]}]
## MC1-69 
set_property PACKAGE_PIN AB17 [get_ports {DOUT[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[2]}]
## MC1-70 
set_property PACKAGE_PIN AB13 [get_ports {DOUT[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[3]}]
## MC1-71 
set_property PACKAGE_PIN AA15 [get_ports {DOUT[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[4]}]
## MC1-72 
set_property PACKAGE_PIN W15 [get_ports {DOUT[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[5]}]
## MC1-73 
set_property PACKAGE_PIN AB15 [get_ports {DOUT[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[6]}]
## MC1-74 
set_property PACKAGE_PIN W16 [get_ports {DOUT[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[7]}]
## MC1-75 
set_property PACKAGE_PIN Y16 [get_ports {DOUT[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {DOUT[8]}]
## MC1-76 
set_property PACKAGE_PIN AA16 [get_ports {DOUT[9]}]
...
#set_property IOSTANDARD  [get_ports {}]
## MC2-15 
set_property PACKAGE_PIN P5 [get_ports {DREAD}]
set_property IOSTANDARD LVCMOS33 [get_ports {DREAD}]
## MC2-16 
set_property PACKAGE_PIN P6 [get_ports {DCLEAR}]
set_property IOSTANDARD LVCMOS33 [get_ports {DCLEAR}]
## MC2-17 
...
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
## MC2-40 
set_property PACKAGE_PIN K3 [get_ports {LASER_IN}]
set_property IOSTANDARD LVCMOS33 [get_ports {LASER_IN}]
#set_property IN_TERM UNTUNED_SPLIT_50 [get_ports {LASER_IN}]
## MC2-41 
...
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
## MC2-72 
set_property PACKAGE_PIN W14 [get_ports {REF_OUT}]
set_property IOSTANDARD LVCMOS33 [get_ports {REF_OUT}]
#set_property OUT_TERM UNTUNED_50 [get_ports {REF_OUT}]
## MC2-73 
